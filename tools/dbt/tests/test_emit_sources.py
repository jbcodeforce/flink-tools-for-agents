...
from tools.dbt.flink_dbt_migrate.discover_deps import resolve_upstream_deps
...
from tools.dbt.flink_dbt_migrate.flink_sql_processor import parse_ddl, parse_dml
